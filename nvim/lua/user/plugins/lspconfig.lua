...
local function get_typescript_server_path(root_dir)
  ...
  local global_tsserverlib = '~/.local/lib/node_modules/typescript/lib/tsserverlibrary.js'
...
--   cmd = { '~/.local/share/nvim/site/pack/packer/opt/phpactor/bin/phpactor', 'language-server' },
--   on_attach = on_attach,
--   capabilities = capabilities,
--   init_options = {
